...
vis_command="mpirun -np 6 remhos --verify-bounds"
...
for method in "${methods[@]}"; do
  ...
  echo $vis_command" -m ./data/periodic-hexagon.mesh -p 0 -rs 2 -dt 0.005 -tf 2.5 "$method >> $file
  ...
  echo $vis_command" -m ./data/periodic-cube.mesh -p 0 -rs 1 -o 2 -dt 0.012 -tf 2 "$method >> $file
